...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResourceControl', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.ResourceControl();
      });

      it('should create an instance of ResourceControl', function() {
        // TODO: update the code to test ResourceControl
        expect(instance).to.be.a(ManageragentsApi.ResourceControl);
      });
