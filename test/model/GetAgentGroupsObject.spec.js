...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAgentGroupsObject', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.GetAgentGroupsObject();
      });

      it('should create an instance of GetAgentGroupsObject', function() {
        // TODO: update the code to test GetAgentGroupsObject
        expect(instance).to.be.a(ManageragentsApi.GetAgentGroupsObject);
      });
