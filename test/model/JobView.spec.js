...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobView', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.JobView();
      });

      it('should create an instance of JobView', function() {
        // TODO: update the code to test JobView
        expect(instance).to.be.a(ManageragentsApi.JobView);
      });
