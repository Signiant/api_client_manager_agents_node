...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AgentGroupsObject', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.AgentGroupsObject();
      });

      it('should create an instance of AgentGroupsObject', function() {
        // TODO: update the code to test AgentGroupsObject
        expect(instance).to.be.a(ManageragentsApi.AgentGroupsObject);
      });
