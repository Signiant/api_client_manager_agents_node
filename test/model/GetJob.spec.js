...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetJob', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.GetJob();
      });

      it('should create an instance of GetJob', function() {
        // TODO: update the code to test GetJob
        expect(instance).to.be.a(ManageragentsApi.GetJob);
      });
