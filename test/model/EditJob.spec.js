...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EditJob', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.EditJob();
      });

      it('should create an instance of EditJob', function() {
        // TODO: update the code to test EditJob
        expect(instance).to.be.a(ManageragentsApi.EditJob);
      });
