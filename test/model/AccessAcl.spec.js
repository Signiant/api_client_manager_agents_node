...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccessAcl', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.AccessAcl();
      });

      it('should create an instance of AccessAcl', function() {
        // TODO: update the code to test AccessAcl
        expect(instance).to.be.a(ManageragentsApi.AccessAcl);
      });
