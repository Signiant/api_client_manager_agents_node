...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AgentGroup', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.AgentGroup();
      });

      it('should create an instance of AgentGroup', function() {
        // TODO: update the code to test AgentGroup
        expect(instance).to.be.a(ManageragentsApi.AgentGroup);
      });
