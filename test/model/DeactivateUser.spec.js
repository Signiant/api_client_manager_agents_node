...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeactivateUser', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.DeactivateUser();
      });

      it('should create an instance of DeactivateUser', function() {
        // TODO: update the code to test DeactivateUser
        expect(instance).to.be.a(ManageragentsApi.DeactivateUser);
      });
