...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListUsersResponse', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.ListUsersResponse();
      });

      it('should create an instance of ListUsersResponse', function() {
        // TODO: update the code to test ListUsersResponse
        expect(instance).to.be.a(ManageragentsApi.ListUsersResponse);
      });
