...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAgentGroup', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.GetAgentGroup();
      });

      it('should create an instance of GetAgentGroup', function() {
        // TODO: update the code to test GetAgentGroup
        expect(instance).to.be.a(ManageragentsApi.GetAgentGroup);
      });
