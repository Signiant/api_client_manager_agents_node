...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeleteJob', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.DeleteJob();
      });

      it('should create an instance of DeleteJob', function() {
        // TODO: update the code to test DeleteJob
        expect(instance).to.be.a(ManageragentsApi.DeleteJob);
      });
