...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobLog', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.JobLog();
      });

      it('should create an instance of JobLog', function() {
        // TODO: update the code to test JobLog
        expect(instance).to.be.a(ManageragentsApi.JobLog);
      });
