...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ActivateUser', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.ActivateUser();
      });

      it('should create an instance of ActivateUser', function() {
        // TODO: update the code to test ActivateUser
        expect(instance).to.be.a(ManageragentsApi.ActivateUser);
      });
