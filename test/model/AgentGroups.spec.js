...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AgentGroups', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.AgentGroups();
      });

      it('should create an instance of AgentGroups', function() {
        // TODO: update the code to test AgentGroups
        expect(instance).to.be.a(ManageragentsApi.AgentGroups);
      });
