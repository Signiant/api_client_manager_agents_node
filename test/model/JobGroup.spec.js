...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobGroup', function() {
      beforeEach(function() {
        instance = new ManageragentsApi.JobGroup();
      });

      it('should create an instance of JobGroup', function() {
        // TODO: update the code to test JobGroup
        expect(instance).to.be.a(ManageragentsApi.JobGroup);
      });
