...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ManageragentsApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://manager.url/signiant/spring/admin/v1.0
     */
    this.basePath = 'https://manager.url/signiant/spring/admin/v1.0'.replace(/\/+$/, '');
